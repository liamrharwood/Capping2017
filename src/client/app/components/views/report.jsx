...
class Report extends React.Component {
	...
	renderButton(){
		switch(this.state.reportStatus){
			case(0): // normal
				return (
					<div className ="col-3 offset-lg-9 offset-sm-6 offset-xs-4 mt-4 text-center">
						<button className = "btn btn-primary" onClick={this.submitReport}>Submit Report</button>
					</div>)
				break;
			case(1): // loading
				return (<div className="col-3 offset-lg-9 offset-sm-6 offset-xs-4 mt-4 text-center">
							<ClipLoader loading={true} size={25} margin={"2px"} color={"#633d91"} />
						</div>)
				break;
			case(2): // success
			...
			case(-1): // error
				return (<div className="col-12 text-center mt-4">
							<div className="alert alert-danger">There was an error in trying to submit your report.</div>
						</div>)
				break;
		}
	}
			...
			<div className="container dashboard" >
				<div className = "row">
					<div className = "col-10 offset-1">
						<h1 className="mb-3">Report a Post</h1>
					</div>
				</div>
				<div className = "row">
					<div className = "col-10 offset-1">
						...
						<div className = "card">
							<div className = "card-body pb-1 container-fluid">
								<div className="form-group">
				        			<label htmlFor="reportText">Report Reason</label>
									<textarea ref="report" className="form-control" id="reportText" style={{ height: 75 }} maxLength="140" placeholder = "Please describe why you are reporting this post" aria-label="lease describe why you are reporting this post" />
