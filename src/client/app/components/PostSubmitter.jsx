		...
		return (
			<div className= "card mb-4">
	      		<div className="input-group" style={{zIndex: 0}}>
				  	<input type="text" ref="title" className="form-control" onChange={this.handleTitleChange} maxLength="140" placeholder="New Post Title" aria-label="New Post Title" />
		        ...
		        <div className={`card-body submitter ${this.state.submitterClass}`}>
		        	<form className="postForm container">
			        	<div className="row">
							...
							<label htmlFor="postBodyText">Select Communities</label>
